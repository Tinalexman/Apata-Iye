  ...
  return (
    <div className="w-full bg-background xs:px-[5%] lg:px-[7rem] lg:py-20 xs:py-10">
      <div className="w-full lg:rounded-2xl xs:rounded-xl lg:h-[13rem] xs:h-[7rem] bg-[url('../../public/bg.jpg')] bg-cover lg:px-20 xs:px-5 lg:py-5 xs:py-3 flex flex-col justify-center relative overflow-hidden">
        ...
        <button className="py-1 lg:mt-5 xs:mt-2 border-primary hover:bg-primary bg-white hover:text-white duration-300 ease-out transition-colors border rounded-xl lg:text-[0.9rem] xs:text-[0.6rem] font-lato text-primary lg:w-[200px] xs:w-[150px]">
          BOOK AN APPOINTMENT
        </button>
        <motion.div
          animate={{
